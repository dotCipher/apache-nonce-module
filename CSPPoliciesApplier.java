/*Sample class from https://www.owasp.org/index.php/Content_Security_Policy
* For implementing filters to implement CSP security policies
* We only need to worry about implementing "script-nonce"
*/
